...
@Component
public class CustomJwtConverterMono implements Converter<Jwt, Mono<AbstractAuthenticationToken>> {
	...
	public Mono<AbstractAuthenticationToken> convert(Jwt source) {
		...
		JwtAuthenticationToken token = new JwtAuthenticationToken(source, authorities, source.getClaim("preferred_username"));
